...
- Монолит получает показания датчашчЖ куфвьуиков (сейчас — синхронный pull/опрашивание или вызов внешнего «температурного» сервиса-адаптера), сохраняет текущее значение и отдаёт веб-клиенту «текущую температуру» по запросу.
